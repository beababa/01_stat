...
```{r}
data <- read.csv("data/rplsBondy.csv", fileEncoding = "UTF-8", dec =".")
...
- produit des écarts (pour étudier le rapport entre 2 variables, techniquement on utiliser une division ou une multiplication)
...
La surface habitable explique moins de 10 % de l'année de construction.
