...
- cette fréquence est multipliée par la totalité de l'effectif pour avoir l' EFFECTIF THEORIQUE
...
```{r}
freq <- prop.table(tab)
freqLg <- prop.table(tab,1)
freqCol <- prop.table(tab,2)
theorique <- freqLg * freqCol / sum(tab)
theorique
freq 
sum(theorique)
sum(tab)
...
8 zone et 3 types d'appartements = 24
...
Les variables nombre de pièces et zones ont une relation avec une marge d'erreur de 5 %
