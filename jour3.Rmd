...
On travaille à présent sur un croisement de deux agrégats financiers.
...
Pour le cours, l'hypothèse est que la non maîtrise des frais de personnel (x) amènent l'augmentation des impôts locaux (y) sur le 93 (budgets consolidés)
...
Quel variable pour expliquer l'augmentation des impôts ?
...
Attention, variable explicative et expliquée.
...
- tcd (données table dynamique dans Calc)
