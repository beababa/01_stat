...
barplot(table(rpls$NBPIECE, useNA = "always"), col = c("cyan", "cyan", "darkolivegreen2", "darkolivegreen2", "cornsilk2","cornsilk2","cornsilk2","cornsilk2","cornsilk2"), border = NA)
...
# Khi2 : Retour à la comparaison secteur / type d'appartement

## Ennoncer l'hypothèse H0

Le type d'appartement est indépendant du quartier.
