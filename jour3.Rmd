...
# Un autre exemple en exercice

on caractérise les bureaux de vote de façon sommaire. Pour Bondy, il s'agit de distinguer
- quartiers Nord
- centre ville
et - quartiers sud

Vous êtes libres de vos zones à partir des cartes diffusées sur umap.

De même, on simplifie le nombre de candidats : gauche, droite, petits gauches et petits droites
