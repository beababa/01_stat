...
Si ce rapport est élevé, cela signifie que la variation intergroupe est importante relativement à la variation intra, donc qu'il y a une vraie différence entre les moyennes des groupes.
...
Plus il est petit, plus il y a de différence, plus il est gros, plus les moyennes se ressemblent et donc l'hypothèse d'indépendance peut être rejetée.
