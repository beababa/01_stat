...
```{r}
# lecture des fichiers du 1er cours et concaténation 
...
### Problème des doublons de prénoms

Chaque exercice est rendu avec le prénom comme nom de fichier. Cela ne fonctionne
que si les prénoms sont uniques. La solution est d'ajouter la 1e lettre du nom de 
famille en cas de doublon.
...
Sauvegarde pour l'émargement prochain
