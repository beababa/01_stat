...
```{r}
rendu <- c(47,36, 29, 14)
titre <- c("distribution", "univarié", "khi2", "khi2bis")
p <- barplot(rendu, names = titre, main = "rendu devoirs (effectif 75 étudiants environ)")
...
```{r}
rpls2019 <- read.csv2("data/RPLS2019_detail_IDF_DEP_93.csv")
head(rpls2019)

rpls2021<- read.csv2("data/rpls2021_geolocalise_OD_REG11_DEP93.csv")
```
