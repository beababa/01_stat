...
Pour les élections 2024

- extraction des pts bureau de vote pour passage sous maps / osm

- comparaison tx abstention européennes et legislatives 2022 par qpv sur Fr entière

- analyse multivariée Bondy Tremblay

- et toujours essai de croisement bondy / tremblay bv IRIS vf rpls
...
pb encodage sur le fichier de base

TODO ai je résolu ce pb pdt mon cours ?


```{r}
Sys.info()['sysname']
ptBv <- read.csv("data/table-bv-reuFILTRE.csv", na.strings = "") 
tail(ptBv)
# 93071 93073 93078
str(ptBv)
cog <- c('93071', '93073', '93078')
ptBv <- ptBv[ ptBv$code_commune %in% cog,]
```


```{r}
table(ptBv$commune_reu)
```
