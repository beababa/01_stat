...
3766 au départ 1557, puis 1554 à la fin
...
mf_map(enveloppe)
st_write(bvBondy, "data/concept.gpkg", "aggBondy")
st_write(bvBondy, "data/concept.gpkg", "enveloppeBondy")
```
...
bvBondy <- st_read("data/concept.gpkg", "bvBondy")
