...
Par exemple, le nombre d'emploi par département dépend du taux de natalité et du
nombre de diplômés et des conditions de logements.
...
Les départements proches suivent le même modèle de données.
